...
public class OptimizedMultiTriArbitrageBot_backup {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OptimizedMultiTriArbitrageBot_backup.class);

    private static final String[][] TRIANGLES = {
    	    {"BTCUSDC", "ETHBTC", "ETHUSDC"},
    	    {"LTCBTC", "BNBBTC", "LTCBNB"},
...
//    	    { "ETHUSDC", "DOGEETH", "DOGEUSDC" },
//    	    { "ETHUSDT", "LTCETH", "LTCUSDT" },
//    	    { "ETHUSDT", "DOGEETH", "DOGEUSDT" },
...
//                                logger.info("📊 Triangle status: {}={} {}={} {}={} (bids)", p1, p1Bid, p2, p2Bid, p3, p3Bid);
                                ...
                                if (p1Ask != null && p2Ask != null && p3Ask != null &&
                                    ...
                                    arbitrageThreadPool.submit(() -> ExchangeRulesManager.checkForArbitrage(
                                            p1, p2, p3, BUY, BUY, SELL, p1Ask, p2Ask, p3Ask, p1Bid, p2Bid, p3Bid));
                                }
                        	}
                        }
                    }
